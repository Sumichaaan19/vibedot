...
yay -S --noconfirm sway waybar rofi neofetch ranger kitty nautilus cava wlogout swww hypridle hyprlock bluetuith hyprshot tokyonight-gtk-theme-git python-pillow nwg-look cmatrix cbonsai tty-clock btop
